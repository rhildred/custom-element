...
var Mt = (D, r, u) => r in D ? Lt(D, r, { enumerable: !0, configurable: !0, writable: !0, value: u }) : D[r] = u;
var G = (D, r, u) => Mt(D, typeof r != "symbol" ? r + "" : r, u), Ut = (D, r, u) => r.has(D) || Et("Cannot " + u);
var bt = (D, r, u) => r.has(D) ? Et("Cannot add the same private member more than once") : r instanceof WeakSet ? r.add(D) : r.set(D, u);
var je = (D, r, u) => (Ut(D, r, "access private method"), u);
function zt(D) {
  return D && D.__esModule && Object.prototype.hasOwnProperty.call(D, "default") ? D.default : D;
}
var Xe = { exports: {} }, Ie = {}, me = {}, ke = {}, wt;
function We() {
  if (wt) return ke;
  wt = 1;
  function D(s, o, d) {
...
function Ft() {
  ...
  var E = {}, _ = E.ELEMENT_NODE = 1, k = E.ATTRIBUTE_NODE = 2, q = E.TEXT_NODE = 3, J = E.CDATA_SECTION_NODE = 4, X = E.ENTITY_REFERENCE_NODE = 5, b = E.ENTITY_NODE = 6, O = E.PROCESSING_INSTRUCTION_NODE = 7, I = E.COMMENT_NODE = 8, L = E.DOCUMENT_NODE = 9, Z = E.DOCUMENT_TYPE_NODE = 10, V = E.DOCUMENT_FRAGMENT_NODE = 11, K = E.NOTATION_NODE = 12, M = {}, z = {};
  ...
  function qe(t) {
    return t && (le(t) || Ne(t) || oe(t) || t.nodeType === B.DOCUMENT_FRAGMENT_NODE || t.nodeType === B.COMMENT_NODE || t.nodeType === B.PROCESSING_INSTRUCTION_NODE);
  }
  function oe(t) {
  ...
  function ee(t, n, i) {
    ...
    if (
      ...
      !qe(n) || // 5. If either `node` is a Text node and `parent` is a document,
  ...
  function Ee(t, n, i, f) {
    ...
    return be(t.ownerDocument || t, t), n.nodeType == V && (n.firstChild = n.lastChild = null), n;
  }
  function $e(t, n) {
  ...
  }, Q.prototype.getElementsByTagName = j.prototype.getElementsByTagName, Q.prototype.getElementsByTagNameNS = j.prototype.getElementsByTagNameNS, x(j, B);
  function te() {
  }
  ...
  Ve.prototype.nodeName = "#document-fragment", Ve.prototype.nodeType = V, x(Ve, B);
  function rt() {
  }
    ...
    switch (t.nodeType) {
      case _:
        ...
        for (var Ce = 0; Ce < H; Ce++) {
          var fe = R.item(Ce);
          if (dt(fe, i, A)) {
            var ye = fe.prefix || "", Oe = fe.namespaceURI;
            ut(n, ye ? "xmlns:" + ye : "xmlns", Oe), A.push({ prefix: ye, namespace: Oe });
          }
          Fe(fe, n, i, f, A);
        }
        if (ie === ge && dt(t, i, A)) {
          var ye = t.prefix || "", Oe = t.namespaceURI;
          ut(n, ye ? "xmlns:" + ye : "xmlns", Oe), A.push({ prefix: ye, namespace: Oe });
        }
        if (ue || i && !/^(?:meta|link|img|br|hr|input)$/i.test(ie)) {
          if (n.push(">"), i && /^script$/i.test(ie))
            for (; ue; )
              ue.data ? n.push(ue.data) : Fe(ue, n, i, f, A.slice()), ue = ue.nextSibling;
          else
            for (; ue; )
              Fe(ue, n, i, f, A.slice()), ue = ue.nextSibling;
          n.push("</", ge, ">");
        } else
          n.push("/>");
        return;
      ...
      case Z:
        var mt = t.publicId, Re = t.systemId;
        if (n.push("<!DOCTYPE ", t.name), mt)
          n.push(" PUBLIC ", mt), Re && Re != "." && n.push(" ", Re), n.push(">");
        else if (Re && Re != ".")
          n.push(" SYSTEM ", Re, ">");
        else {
  ...
  function J(h, v, N, T, F) {
    ...
    function p(j) {
      if (j > Q) {
        ...
        B && m(Q), T.characters(te, 0, j - Q), Q = j;
      }
    }
    function m(j, te) {
      for (; j >= C && (te = U.exec(h)); )
      ...
      try {
        ...
        switch (W > Q && p(W), h.charAt(W + 1)) {
          case "/":
            ...
            var qe = ce.localNSMap, oe = ce.tagName == ne, le = oe || ce.tagName && ce.tagName.toLowerCase() == ne.toLowerCase();
            if (le) {
              if (T.endElement(ce.uri, ce.localName, ne), qe)
                for (var Ne in qe)
                  Object.prototype.hasOwnProperty.call(qe, Ne) && T.endPrefixMapping(Ne);
          ...
          default:
            B && m(W);
            var re = new M(), Se = Y[Y.length - 1].currentNSMap, ee = b(h, W, re, Se, c, F), Ue = re.length;
            if (!re.closed && L(h, ee, re.tagName, ae) && (re.closed = !0, N.nbsp || F.warning("unclosed xml attribute")), B && Ue) {
              ...
              T.locator = ze, O(re, T, Se) && Y.push(re), T.locator = B;
            } else
              O(re, T, Se) && Y.push(re);
...
function Vt() {
  if (yt) return Le;
  yt = 1;
  var D = We(), r = Ft(), u = $t(), e = Pt(), a = r.DOMImplementation, s = D.NAMESPACE, o = e.ParseError, d = e.XMLReader;
  function g(b) {
    return b.replace(/\r[\n\u0085]/g, `
`).replace(/[\r\u0085\u2028]/g, `
`);
  ...
  x.prototype.parseFromString = function(b, O) {
    var I = this.options, L = new d(), Z = I.domBuilder || new _(), V = I.errorHandler, K = I.locator, M = I.xmlns || {}, z = /\/x?html?$/.test(O), h = z ? u.HTML_ENTITIES : u.XML_ENTITIES;
    K && Z.setDocumentLocator(K), L.errorHandler = E(V, Z, K), L.domBuilder = I.domBuilder || Z, z && (M[""] = s.HTML), M.xml = M.xml || s.XML;
  ...
  _.prototype = {
    ...
    startElement: function(b, O, I, L) {
      var Z = this.doc, V = Z.createElementNS(b, I || O), K = L.length;
...
@` + (b.systemId || "") + "#[line:" + b.lineNumber + ",col:" + b.columnNumber + "]";
  ...
  return Le.__DOMHandler = _, Le.normalizeLineEndings = g, Le.DOMParser = x, Le;
}
var kt;
function jt() {
  if (kt) return Ie;
  kt = 1;
  var D = Ft();
  return Ie.DOMImplementation = D.DOMImplementation, Ie.XMLSerializer = D.XMLSerializer, Ie.DOMParser = Vt().DOMParser, Ie;
}
var Ht = Xe.exports, Tt;
function Gt() {
  return Tt || (Tt = 1, function(D) {
    (function(r, u) {
      ...
      return function(e) {
        ...
        function q(l) {
          ...
          } else l.indexOf("Z", l.length - 1) !== -1 && (m = new Date(Date.UTC(m.getFullYear(), m.getMonth(), m.getDate(), m.getHours(), m.getMinutes(), m.getSeconds(), m.getMilliseconds())));
          return m;
        }
        function J(l, c, p) {
...
const qt = /[&<>"']/, Qt = new RegExp(qt.source, "g"), Ot = /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/, Yt = new RegExp(Ot.source, "g"), Wt = {
  "&": "&amp;",
  "<": "&lt;",
  ">": "&gt;",
  '"': "&quot;",
...
function se(D, r) {
  if (r) {
    if (qt.test(D))
      return D.replace(Qt, _t);
  } else if (Ot.test(D))
    return D.replace(Yt, _t);
  return D;
}
const Jt = /&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig;
function Kt(D) {
  return D.replace(Jt, (r, u) => (u = u.toLowerCase(), u === "colon" ? ":" : u.charAt(0) === "#" ? u.charAt(1) === "x" ? String.fromCharCode(parseInt(u.substring(2), 16)) : String.fromCharCode(+u.substring(1)) : ""));
}
const er = /(^|[^\[])\^/g;
function P(D, r) {
  D = typeof D == "string" ? D : D.source, r = r || "";
  const u = {
    replace: (e, a) => (a = typeof a == "object" && "source" in a ? a.source : a, a = a.replace(er, "$1"), D = D.replace(e, a), u),
  ...
  table(r) {
    ...
    if (u) {
      ...
      const e = {
        type: "table",
        raw: u[0],
        header: Nt(u[1]).map((a) => ({ text: a, tokens: [] })),
...
`) : []
      ...
      if (e.header.length === e.align.length) {
        ...
        for (a = e.rows.length, s = 0; s < a; s++)
          e.rows[s] = Nt(e.rows[s], e.header.length).map((x) => ({ text: x, tokens: [] }));
  ...
  link(r) {
    ...
    if (u) {
      ...
      if (this.options.pedantic) {
        ...
        s = u[3] ? u[3].slice(1, -1) : "";
      return a = a.trim(), /^</.test(a) && (this.options.pedantic && !/>$/.test(e) ? a = a.slice(1) : a = a.slice(1, -1)), St(u, {
...
class he {
  constructor(r) {
    ...
    G(this, "tokenizer");
    G(this, "inlineQueue");
    this.tokens = [], this.tokens.links = /* @__PURE__ */ Object.create(null), this.options = r || Be, this.options.tokenizer = this.options.tokenizer || new Qe(), this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options, this.tokenizer.lexer = this, this.inlineQueue = [], this.state = {
      inLink: !1,
      inRawBlock: !1,
      top: !0
    };
...
class de {
  constructor(r) {
    ...
    G(this, "renderer");
    G(this, "textRenderer");
    this.options = r || Be, this.options.renderer = this.options.renderer || new Ye(), this.renderer = this.options.renderer, this.renderer.options = this.options, this.textRenderer = new lt();
  }
  /**
   * Static Parse Method
   */
  ...
  parse(r, u = !0) {
    ...
    for (let a = 0; a < r.length; a++) {
      ...
      switch (s.type) {
        ...
        case "heading": {
          const o = s;
          e += this.renderer.heading(this.parseInline(o.tokens), o.depth, Kt(this.parseInline(o.tokens, this.textRenderer)));
          continue;
        }
        case "code": {
          const o = s;
...
G(Me, "passThroughHooks", /* @__PURE__ */ new Set([
  "preprocess",
  "postprocess"
]));
var _e, at, It;
class ur {
  constructor(...r) {
    ...
    G(this, "parse", je(this, _e, at).call(this, he.lex, de.parse));
    G(this, "parseInline", je(this, _e, at).call(this, he.lexInline, de.parseInline));
    G(this, "Parser", de);
    G(this, "Renderer", Ye);
  ...
  use(...r) {
    ...
    return r.forEach((e) => {
      ...
      if (a.async = this.defaults.async || a.async || !1, e.extensions && (e.extensions.forEach((s) => {
        ...
        const s = this.defaults.renderer || new Ye(this.defaults);
      ...
      if (e.hooks) {
        const s = this.defaults.hooks || new Me();
        for (const o in e.hooks) {
          const d = e.hooks[o], g = o, x = s[g];
          Me.passThroughHooks.has(o) ? s[g] = (E) => {
...
_e = new WeakSet(), at = function(r, u) {
  return (e, a) => {
    ...
    const d = je(this, _e, It).call(this, !!o.silent, !!o.async);
...
$.options = $.setOptions = function(D) {
  return Te.setOptions(D), $.defaults = Te.defaults, Rt($.defaults), $;
};
$.getDefaults = ot;
$.defaults = Be;
$.use = function(...D) {
  return Te.use(...D), $.defaults = Te.defaults, Rt($.defaults), $;
};
$.walkTokens = function(D, r) {
...
class ir extends HTMLElement {
  ...
  async connectedCallback() {
    ...
    let a = new Zt().xml2js(u), s = "files:<br />";
...
customElements.define("x-sitemap", ir);
  ...
  async connectedCallback() {
    if (!this.ariaExpanded) {
      ...
      if (this.ariaExpanded = !0, window.frameElement && window.frameElement.getAttribute("data-src"))
        r = window.frameElement.getAttribute("data-src");
      else if (window.location.search) {
        const e = new URLSearchParams(window.location.search).get("src");
        e && (r = e);
      } else if (this.attributes.src)
        r = this.attributes.src, typeof r != "string" && (r = this.attributes.src.value);
      else {
        this.innerHTML = st(this.innerHTML);
        return;
      }
      try {
        const u = new URL(r.replace("https:/", "https://wp-now-corsproxy.rhildred.workers.dev/corsproxy")), a = await (await fetch(u)).text();
        if (this.innerHTML = st(a), window.frameElement) {
        ...
        const u = new URL(this.attributes.src.baseURI), e = u.pathname.slice(0, u.pathname.lastIndexOf("/") + 1), a = u.origin + e + this.attributes.src.value + u.search, o = await (await fetch(a)).text();
        this.innerHTML = st(o);
      }
    }
  }
}
customElements.define("x-markdown2html", sr);
...
customElements.define("x-scorm", ar);
class or extends HTMLElement {
  ...
  async connectedCallback() {
    if (!this.ariaExpanded) {
      ...
      this.innerHTML = await nr(r);
    }
  }
}
customElements.define("x-workbook", or);
...
customElements.define("x-marking", lr);
